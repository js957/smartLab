...
package com.ynusmartgrid.face_.hktv.ClientDemo;
...
import com.ynusmartgrid.face_.common.HttpClientHelper;
 ...
 *容器：Jframe
 ****************************************************************************/
public class ClientDemo1 extends JFrame
{
    /*************************************************
    函数:      主类构造函数
    函数描述:	初始化成员
    ...
    private void initComponents() {
        ...
        jComboBoxCallback = new JComboBox();
        jSplitPaneVertical = new JSplitPane();
        jPanelRealplayArea = new JPanel();
        panelRealplay = new Panel();
        jScrollPanelAlarmList = new JScrollPane();
        jTableAlarm = new JTable();
        jMenuBarConfig = new JMenuBar();
        jMenuConfig = new JMenu();
        jMenuItemBasicConfig = new JMenuItem();
        jMenuItemNetwork = new JMenuItem();
        jMenuItemChannel = new JMenuItem();
        jMenuItemAlarmCfg = new JMenuItem();
        jMenuItemSerialCfg = new JMenuItem();
        jMenuItemUserConfig = new JMenuItem();
        jMenuItemIPAccess = new JMenuItem();
        jMenuPlayBack = new JMenu();
        jMenuItemPlayBackRemote = new JMenuItem();
        jMenuItemPlayTime = new JMenuItem();
        jMenuSetAlarm = new JMenu();
        jRadioButtonMenuSetAlarm = new JRadioButtonMenuItem();
        jRadioButtonMenuListen = new JRadioButtonMenuItem();
        jMenuItemRemoveAlarm = new JMenuItem();
        jMenuManage = new JMenu();
        jMenuItemCheckTime = new JMenuItem();
        jMenuItemFormat = new JMenuItem();
        jMenuItemUpgrade = new JMenuItem();
        jSeparator1 = new JSeparator();
        jMenuItemReboot = new JMenuItem();
        jMenuItemShutDown = new JMenuItem();
        jSeparator2 = new JSeparator();
        jMenuItemDefault = new JMenuItem();
        jMenuItemDeviceState = new JMenuItem();
        jMenuVoice = new JMenu();
        jMenuItemVoiceCom = new JMenuItem();

        setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE);
        setTitle("ClientDemo");
        setFont(new Font("宋体", 0, 10));

        jSplitPaneHorizontal.setBorder(BorderFactory.createEmptyBorder(1, 1, 1, 1));
        jSplitPaneHorizontal.setDividerLocation(155);
        jSplitPaneHorizontal.setDividerSize(2);

        jPanelUserInfo.setBorder(BorderFactory.createEtchedBorder(new Color(204, 255, 255), null));
        ...
        jTextFieldIPAddress.setText("192.168.1.93");

        jLabelPortNumber.setText("端口");

        jLabelPassWord.setText("密码");

        jPasswordFieldPassword.setText("xxjsb411");
        ...
        jComboBoxCallback.setModel(new DefaultComboBoxModel(new String[] { "直接预览", "回调预览" }));

        GroupLayout jPanelUserInfoLayout = new GroupLayout(jPanelUserInfo);
        ...
        jPanelUserInfoLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelUserInfoLayout.createSequentialGroup()
                ...
                .addGap(26, 26, 26)
                .addComponent(jPasswordFieldPassword, GroupLayout.PREFERRED_SIZE, 80, GroupLayout.PREFERRED_SIZE))
            .addGroup(jPanelUserInfoLayout.createSequentialGroup()
                .addContainerGap()
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, jPanelUserInfoLayout.createSequentialGroup()
        ...
        jPanelUserInfoLayout.setVerticalGroup(
            ...
            .addGroup(jPanelUserInfoLayout.createSequentialGroup()
                ...
                .addGroup(jPanelUserInfoLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    .addComponent(jLabelPortNumber)
                    .addComponent(jTextFieldPortNumber, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanelUserInfoLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(jButtonLogin)
                    .addComponent(jButtonRealPlay))
                .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(jScrollPaneTree, GroupLayout.PREFERRED_SIZE, 404, GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jComboBoxCallback, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
                .addComponent(jButtonExit)
        ...
        jPanelRealplayArea.setBorder(BorderFactory.createLineBorder(new Color(153, 255, 102)));
        ...
        GroupLayout panelRealplayLayout = new GroupLayout(panelRealplay);
        ...
        GroupLayout jPanelRealplayAreaLayout = new GroupLayout(jPanelRealplayArea);
        ...
        jPanelRealplayAreaLayout.setHorizontalGroup(
            ...
            .addComponent(panelRealplay, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        jPanelRealplayAreaLayout.setVerticalGroup(
            jPanelRealplayAreaLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addComponent(panelRealplay, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );

        jSplitPaneVertical.setTopComponent(jPanelRealplayArea);

        jScrollPanelAlarmList.setBorder(BorderFactory.createEtchedBorder());
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jSplitPaneHorizontal, GroupLayout.DEFAULT_SIZE, 866, Short.MAX_VALUE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addComponent(jSplitPaneHorizontal, GroupLayout.DEFAULT_SIZE, 671, Short.MAX_VALUE)
        );
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        ...
        net_dvr_jpegpara.setwPicSize((short) 5);
        net_dvr_jpegpara.setwPicQuality((short) 0);


        hCNetSDK.NET_DVR_CaptureJPEGPicture(lUserID,new NativeLong(1),net_dvr_jpegpara,"D:\\wyw\\img\\1.jpeg");

        long userID = lUserID.longValue();
        if (userID == -1)
        {
            m_sDeviceIP = "";//登录未成功,IP置为空
            JOptionPane.showMessageDialog(ClientDemo1.this, "注册失败");
        }
        else
        {
            CreateDeviceTree();
...
//  void getuserid(){
//        m_strDeviceInfo = new HCNetSDK.NET_DVR_DEVICEINFO_V30();
//        lUserID = hCNetSDK.NET_DVR_Login_V30("192.168.1.93",
//                (short) 8000, "admin", "admin:xxjsb411", m_strDeviceInfo);
//
//    }
  /*************************************************
    函数:       主函数
...
new Thread(new Runnable()
        {
            ...
            public void run()
            {
                ...
                userid = hCNetSDK.NET_DVR_Login_V30("192.168.1.91",
                        (short) 8000, "admin", "xxjsb411", net_dvr_deviceinfo_v30);
                HCNetSDK.NET_DVR_JPEGPARA net_dvr_jpegpara = new HCNetSDK.NET_DVR_JPEGPARA();
                net_dvr_jpegpara.setwPicSize((short) 2);
                net_dvr_jpegpara.setwPicQuality((short) 0);
                while (true){
                    Date date = new Date();
                    ...
                    boolean a;
                    int dwPicSize = new Integer(1280*720);
                    IntByReference lpSizeReturned = new IntByReference();
                    lpSizeReturned.setValue(0);

                    Pointer pointer = new Memory(1280*720);
                    a=hCNetSDK.NET_DVR_CaptureJPEGPicture_NEW(userid,new NativeLong(1),net_dvr_jpegpara,pointer,dwPicSize,lpSizeReturned);
                    byte[] bytes = null;
...
//                        File f1 = new File("D:\\wyw\\img\\test\\"+sdf.format(date)+".jpg");
...
//                    }
    ...
    private JComboBox jComboBoxCallback;
    private JLabel jLabelIPAddress;
    private JLabel jLabelPassWord;
    private JLabel jLabelPortNumber;
    private JLabel jLabelUserName;
    private JMenuBar jMenuBarConfig;
    private JMenu jMenuConfig;
    private JMenuItem jMenuItemAlarmCfg;
    private JMenuItem jMenuItemBasicConfig;
    private JMenuItem jMenuItemChannel;
    private JMenuItem jMenuItemCheckTime;
    private JMenuItem jMenuItemDefault;
    private JMenuItem jMenuItemDeviceState;
    private JMenuItem jMenuItemFormat;
    private JMenuItem jMenuItemIPAccess;
    private JMenuItem jMenuItemNetwork;
    private JMenuItem jMenuItemPlayBackRemote;
    private JMenuItem jMenuItemPlayTime;
    private JMenuItem jMenuItemReboot;
    private JMenuItem jMenuItemRemoveAlarm;
    private JMenuItem jMenuItemSerialCfg;
    private JMenuItem jMenuItemShutDown;
    private JMenuItem jMenuItemUpgrade;
    private JMenuItem jMenuItemUserConfig;
    private JMenuItem jMenuItemVoiceCom;
    private JMenu jMenuManage;
    private JMenu jMenuPlayBack;
    private JMenu jMenuSetAlarm;
    private JMenu jMenuVoice;
    private JPanel jPanelRealplayArea;
    private JPanel jPanelUserInfo;
    private JPasswordField jPasswordFieldPassword;
    private JRadioButtonMenuItem jRadioButtonMenuListen;
    private JRadioButtonMenuItem jRadioButtonMenuSetAlarm;
    private JScrollPane jScrollPaneTree;
    private JScrollPane jScrollPanelAlarmList;
