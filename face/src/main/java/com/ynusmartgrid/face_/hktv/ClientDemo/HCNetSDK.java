...
//时间点
	...
	仅支持当前分辨率的抓图*/
        ...
        public short getwPicSize() {
            return wPicSize;
        }

        public void setwPicSize(short wPicSize) {
            this.wPicSize = wPicSize;
        }

        public short getwPicQuality() {
            return wPicQuality;
        }

        public void setwPicQuality(short wPicQuality) {
            this.wPicQuality = wPicQuality;
        }
    }
