...
//         java.awt.EventQueue.invokeLater
        ...
        String urlStr = "http://192.168.1.6/api.php/api/getMonitors";
        String jsonStr = null;
        try {
        ...
        net_dvr_jpegpara.setwPicQuality((short) 0);
        int startMonitorIndex = 0;
        int lastMonitorIndex = monitorList.size() - 1;
        ThreadPoolExecutor threadPoolExecutor = (ThreadPoolExecutor) Executors.newFixedThreadPool(monitorList.size());
        for(Monitor monitor : monitorList){

            //RunGetPictureThread runGetPictureThread = new RunGetPictureThread(monitor, net_dvr_jpegpara);
            //threadPoolExecutor.submit(runGetPictureThread);
        }
...
//                userid = hCNetSDK.NET_DVR_Login_V30("192.168.1.72",
...
//                    boolean a;
//                    a=hCNetSDK.NET_DVR_CaptureJPEGPicture(userid,new NativeLong(1),net_dvr_jpegpara,"D:\\wyw\\img\\"+sdf.format(date)+"_abc.jpg");
