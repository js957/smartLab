...
public class JDialogMotionDetect extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        panelPlay.addMouseListener(new MouseAdapter() {
    ...
    函数描述:   注册回调函数开始画图
     *************************************************/
    private void panelPlayMousePressed(MouseEvent evt)//GEN-FIRST:event_panelPlayMousePressed
    ...
    函数描述:   画框
     *************************************************/
    private void panelPlayMouseDragged(MouseEvent evt)//GEN-FIRST:event_panelPlayMouseDragged
    ...
    private JList jListTraggerAlarmOut;
    private JList jListTraggerRecord;
